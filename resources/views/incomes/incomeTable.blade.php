                        ...
                        <table class="table table-hover text-nowrap data-table" id="myTable">
                            ...
                            @foreach ($incomes as $income)
                                <tr>
                                    ...
                                    <td>
                                        <a href="/expenses/edit/{{ $income->id }}"
                                           class="btn btn-primary primary-btn fas fa-edit"> Editar</a>
                                    </td>
                                    <td>
                                        <a href="#"></a>
                                        <form action="/expenses/{{ $income->id }}" method="POST">
                                            @csrf
                                            @method('DELETE')
...
@section('js')
    ...
    <script>
        ...
        @foreach ($grafics_date as $item)
        legendas.push("{{ $months[$item->month] }}")
